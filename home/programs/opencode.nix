...
in
{
  ...
  # All pkgs access inside config block to avoid infinite recursion
  config = mkIf cfg.enable (
    let
      # jsonFormat must be inside config block - accessing pkgs.formats at module load time causes recursion
